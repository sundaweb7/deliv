	...
	<div class="app-header-inner">
		...
		<div class="app-header-start">
			...
			<ul class="navbar-nav gap-4 flex-row d-none d-xxl-flex">
				<li class="nav-item">
					<a class="nav-link" href="{{ safe_route('analytics') }}">Reports & Analytics</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="{{ safe_route('faq') }}">Help</a>
				</li>
			</ul>
		</div>
		<div class="app-header-end">
			...
			<div class="d-flex align-items-center gap-sm-2 gap-0 px-lg-4 px-sm-2 px-1">
				<a href="{{ safe_route('inbox') }}" class="btn btn-icon btn-action-gray rounded-circle waves-effect waves-light position-relative">
							...
							<ul class="list-group list-group-hover list-group-smooth list-group-unlined">
								<li class="list-group-item d-flex justify-content-between align-items-center">
									<div class="avatar avatar-xs avatar-status-success rounded-circle me-1">
										<img src="{{ asset('theme/gxon-assets/images/avatar/avatar2.jpg') }}" alt="">
									</div>
								...
								<li class="list-group-item d-flex justify-content-between align-items-center">
									<div class="avatar avatar-xs avatar-status-success rounded-circle me-1">
										<img src="{{ asset('theme/gxon-assets/images/avatar/avatar3.jpg') }}" alt="">
									</div>
									<div class="ms-2 me-auto">
								...
								<li class="list-group-item d-flex justify-content-between align-items-center">
									<div class="avatar avatar-xs avatar-status-danger rounded-circle me-1">
										<img src="{{ asset('theme/gxon-assets/images/avatar/avatar5.jpg') }}" alt="">
									</div>
									<div class="ms-2 me-auto">
				...
				<a href="{{ safe_route('calendar') }}" class="btn btn-icon btn-action-gray rounded-circle waves-effect waves-light">
			...
			<div class="dropdown text-end ms-sm-3 ms-2 ms-lg-4">
				<a href="javascript:void(0);" class="d-flex align-items-center py-2" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="true">
					...
					<div class="avatar avatar-sm rounded-circle avatar-status-success">
						<img src="{{ asset('theme/gxon-assets/images/avatar/avatar1.jpg') }}" alt="">
					</div>
				</a>
				<ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
					...
					<li>
						<a class="dropdown-item d-flex align-items-center gap-2" href="{{ safe_route('profile') }}">
							<i class="fi fi-rr-user scale-1x"></i> View Profile
						</a>
					</li>
					<li>
						<a class="dropdown-item d-flex align-items-center gap-2" href="{{ safe_route('task-management') }}">
							<i class="fi fi-rr-note scale-1x"></i> My Task
						</a>
					</li>
					<li>
						<a class="dropdown-item d-flex align-items-center gap-2" href="{{ safe_route('faq') }}">
					...
					<li>
						<a class="dropdown-item d-flex align-items-center gap-2" href="{{ safe_route('pricing') }}">
					...
					<li>
						<a class="dropdown-item d-flex align-items-center gap-2 text-danger" href="{{ safe_route('login-basic') }}">
